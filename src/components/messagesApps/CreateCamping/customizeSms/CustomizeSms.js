                                            ...
                                            <div className="row">
                                                    ...
                                                    <div className="card">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-xl-12 mb-3">
                                                                ...
                                                                />
                                                                <span><small>Enter Your Mobile Number With Country Code +91.</small></span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="col-xl-3 mb-3">
                                                    ...
                                                    <Button className="mx-0 my-3 d-flex align-items-center">
                                                            <FaHashtag className="me-2" /> Headers
                                                        </Button>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div className="d-flex align-items-center justify-content-between">
                                                                ...
                                                                <span>
                                                                    <div class="form-check form-switch">
                                                                        ...
                                                                        <label class="form-check-label" for="flexSwitchCheckDefault"><small>Auto Shorten</small>
                                                                        </label>
                                                                    </div>
                                                                </span>
                                                                <span>
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" />
                                                                        <label class="form-check-label" for="flexSwitchCheckDefault"><small>Flash</small>
                                                                        </label>
                                                                    </div>
                                                                </span>
                                                                <div className="">
