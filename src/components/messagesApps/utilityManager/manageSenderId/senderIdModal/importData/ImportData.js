                                ...
                                <div className="card">
                                    <div className="card-body p-0">
                                        <div className="table-responsive active-projects style-1">
                                            ...
                                            <p><small>✔️Total Valid Entries: 0</small></p>
                                            <p><small>✖️ Duplicate Numbers: 0</small></p>
                                            <h6>Note</h6>
                                            <ol>
                                                <li>👉 Only CSV and XLSX format files are allowed for import.</li>
                                                <li>👉 The first column should be `senderId`, the second column should be `peId`, and the fifth column should be `description`.</li>
                                            </ol>
