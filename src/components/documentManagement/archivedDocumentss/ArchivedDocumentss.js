...
import ArchivedDocumentssFilter from "./archivedDocumentssFilter/ArchivedDocumentssFilter";



const ArchivedDocumentss = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Document Management",
        title_2: 'Archived Documents',
        path_2: ``
    };
    return (
        <>
            <Breadcrumbs breadCrumbsTitle={breadCrumbsTitle} />
            <ArchivedDocumentssFilter />
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0"><b>Archived Documents </b></h4>
                                        <div>
...
export default ArchivedDocumentss