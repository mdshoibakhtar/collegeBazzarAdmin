...
import BrodBandReport from './BrodBandPostPaidReport'
import CableTvReport from './BrodBandPostPaidReport'
import BrodBandPostPaidReport from './BrodBandPostPaidReport'
import { useParams } from 'react-router-dom'
import Loadar from '../../common/loader/Loader'
function BrodBandPostPaidcomp({title_1,title_2,title}) {
  ...
  return (
    <>
      ...
      <BrodBandPostPaidReport title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData}/>
    </>
  )
}

export default BrodBandPostPaidcomp
