...
function ShippingAddressList({data,confirm,cancel,editShippingAddress}) {
  return (
    <> {data &&
                                ...
                                <tbody>
                                    {data?.map((item) => {
                                        return <tr role="row" className="odd">
                                            ...
                                            <td>
                                                <Link to={`#`} onClick={()=>editShippingAddress(item._id)} className="btn btn-primary shadow btn-xs sharp me-1"><i className="fa fa-pencil" /></Link>
