...
import FastagListReports from './LoanRepaymentListReport'
import LoanRepaymentListReport from './LoanRepaymentListReport'
import { useParams } from 'react-router-dom'

function LoanrepaymentMainComp({title_1,title_2,title}) {
  ...
  return (
    <>
      ...
      <LoanRepaymentListReport title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData}/>
    </>
  )
}

export default LoanrepaymentMainComp
