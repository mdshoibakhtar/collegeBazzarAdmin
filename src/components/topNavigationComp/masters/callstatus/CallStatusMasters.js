...
import {  deleteCallStatusById, deleteTypes_Of_ApprovedBy_Master, getApprovedBy_Master, getCallsStatusByUser } from '../../../../api/login/Login'
...
function CallStatusMasters() {
    const breadCrumbsTitle = {
        title_1: "master",
        title_2: "Call Status Master ",
    }
    ...
    const getFloorMasters = async (page) => {
        ...
        setLoading(true)
        try {
            const res = await getCallsStatusByUser(param?.id, page)
...
export default CallStatusMasters
