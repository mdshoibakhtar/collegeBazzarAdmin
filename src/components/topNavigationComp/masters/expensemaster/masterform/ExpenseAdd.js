...
function ExpenseAdd() {
    const breadCrumbsTitle = {
        title_1: "master",
        title_2: "Available Expense Master",
    };
        ...
        try {
            if (!params?.id) {
                ...
                if (res?.statusCode == "200") {
                    toastSuccessMessage("Available Expense successfully added");
                ...
                if (res?.statusCode == "200") {
                    toastSuccessMessage("Available Expense successfully updated");
                    setTimeout(() => navigate(`/Expense-Master`), 2000);
                }
                blankBtn();
            }
                        ...
                        <div className="table-responsive active-projects style-1">
                            <div className="tbl-caption tbl-caption-2">
                                <h4 className="heading mb-0" style={{padding:"10px"}}>
                                    {params?.id ? "Update" : "Add"} Available Expense
                                </h4>
                            </div>
                            <Formik
