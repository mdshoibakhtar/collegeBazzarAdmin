...
import {  addTypes_Of_ApprovedBy_Master,getApprovedBy_MasterId, getCallByStatusId, getDealById, postCallStatus, postDeal, updateCallStatusById, updateDealById, updateTypes_Of_ApprovedBy_Master,} from '../../../../../api/login/Login';
            ...
            if (!params?.id) {
                try {
                    ...
                    if (res?.statusCode == "200") {
                        toastSuccessMessage("Deal Added Successfully");
                        navigate(`/deal-list`)
                    }
                    blankBtn()
                } catch (error) {
                ...
                try {
                    ...
                    if (res?.statusCode == "200") {
                        toastSuccessMessage("Deal Update Successfully");
                        blankBtn()
                        navigate(`/deal-list`)
                    }
