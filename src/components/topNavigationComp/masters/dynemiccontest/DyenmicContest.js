...
function DyenmicContest({title}) {
    ...
    return (
        <>
            ...
            <ConvertStatusMasterList title={title} totalCount={totalCount} page={page} onChangeVal={onChangeVal} data={data}  count={count} confirm={confirm} cancel={cancel} loading={loading}/>
        </>
    )
}

export default DyenmicContest
