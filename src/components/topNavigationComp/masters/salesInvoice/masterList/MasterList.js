                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0">Sales Invoice Type</h4>
                                        <div>
                                            <Link className="btn btn-primary btn-sm" to="/add-Sales-Invoice-Type" role="button" aria-controls="offcanvasExample">+ Sales Invoice Type</Link>
