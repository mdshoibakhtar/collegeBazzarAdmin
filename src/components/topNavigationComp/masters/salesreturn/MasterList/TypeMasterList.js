                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0">List Of Sales Return</h4>
                                        <div>
                                            <Link className="btn btn-primary btn-sm" to="/add-sales-return" role="button" aria-controls="offcanvasExample">+ ADD Sales Return </Link>
                                        </div>
                                    </div>
                                        ...
                                        <table id="employees-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="employees-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px' }}>Sales Account</th>
                                                        ...
                                                        <tr role="row" key={item?._id}>
                                                            ...
                                                            <td>
                                                                <div className="d-flex">
                                                                    <Link to={`/add-sales-return/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1">
