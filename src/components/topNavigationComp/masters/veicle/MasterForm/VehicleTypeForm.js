...
function VehicleTypeForm() {
    ...
    const validate = (values) => {
        let errors = {};
        if (!values.isActive) {
            errors.isActive = "Vehicle Type status is required";
        }
        if (!values.name) {
            errors.name = "Vehicle Type name is required";
        }
        if (!values.slug) {
            errors.slug = "Vehicle Type slug is required";  // Validation for slug field
        }
        return errors;
    };
                        ...
                        <div className="table-responsive active-projects style-1">
                            <div className="tbl-caption tbl-caption-2">
                                <h4 className="heading mb-0">
                                    {params?.id ? "UPDATE" : "ADD"} Vehicle Type
                                </h4>
                            </div>
                            <Formik
