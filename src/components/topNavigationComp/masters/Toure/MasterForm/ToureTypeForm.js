...
function ToureTypeForm() {
    const breadCrumbsTitle = {
        title_1: "master",
        title_2: "Add Toure Type",
    };
    ...
    const validate = (values) => {
        let errors = {};
        if (!values.isActive) {
            errors.isActive = "Toure Type status is required";
        }
        if (!values.name) {
            errors.name = "Toure Type name is required";
        }
        if (!values.slug) {
            errors.slug = "Toure Type slug is required";  // Validation for slug field
        }
        return errors;
    };
                        ...
                        <div className="table-responsive active-projects style-1">
                            <div className="tbl-caption tbl-caption-2">
                                <h4 className="heading mb-0">
                                    {params?.id ? "UPDATE" : "ADD"} Toure Type
                                </h4>
                            </div>
                            <Formik
