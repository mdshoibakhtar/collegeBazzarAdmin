...
function NumberSeriesMasterList() {
    return (
        <>
            <div className="row">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th className="sorting" tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-label="Status: activate to sort column ascending" style={{ width: '96.125px' }}>
                                                Status</th>
                                            <th tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-label="Contact Number: activate to sort column ascending" style={{ width: '161.675px' }}>
                                                Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr role="row" className="odd">
                                            ...
                                            <td><span>98643757455647 </span></td>
                                            <td className="sorting_1"><span>78</span></td>
                                            <td>
                                                Delhi
                                            </td>
...
export default NumberSeriesMasterList