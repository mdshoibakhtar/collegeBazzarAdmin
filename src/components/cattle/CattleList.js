                        ...
                        <div className="card shadow-sm border-0">
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6>Total Purchased: <strong>89061</strong></h6>
                                        <p>Reproduction: <strong>3334995</strong></p>
                                    </div>
                    ...
                    <div className="col-xl-3 col-md-6 mb-4">
                        <div className="card shadow-sm border-0">
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center">
                                    <div>
                                    <h6>Total Purchased: <strong>214</strong></h6>
                                    <p>Reproduction: <strong>3334995</strong></p>
                                    </div>
                                    <FaWarehouse size={30} />
                                </div>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption d-flex justify-content-between align-items-center" style={{ marginBottom: "10px" }}>
                                    <h4 className="heading mb-0">Livestock List</h4>
                                    <div>
                                        <Link className="btn btn-primary btn-sm" to="/add-cattle" role="button" aria-controls="offcanvasExample">+ Add New Cattle</Link>
                                    </div>
                                </div>
                                            ...
                                            <tr role="row" className="odd" key={item._id}>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        <Link to={`/edit-cattle/${item._id}`} className="btn btn-warning btn-sm me-1">
                                                            <FaRegEdit /> Edit
                                                        </Link>
                                                        <Popconfirm
                                                        ...
                                                        >
                                                            <button className="btn btn-danger btn-sm me-1">
                                                                <i className="fa fa-trash" /> Eliminate
                                                            </button>
                                                        </Popconfirm>
                                                        <Link to={`/cattle-variant`} className="btn btn-primary btn-sm me-1">+ Add variant</Link>
                                                        <Link to={`/live-stock-variant`} className="btn btn-info btn-sm">See variant</Link >
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
