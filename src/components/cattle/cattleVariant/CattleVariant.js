...
const CattleVareiant = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Cattle",
        title_2: "Cattle Varrient",
    };
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0">Add New variant</h4>
                                </div>
                                    ...
                                    <div className="row">
                                        <div className=' col-xl-6 mb-3'>
                                            <div className='row'>
                                                ...
                                                <div className="col-xl-6 mb-3">
                                                    <div className={`form-group ${errors.dc1 ? 'has-error' : ''}`}>
                                                        <input
                                                            id="dc1"
                                                            name="dc1"
                                                            value={formValues.dc1}
                                                            onChange={handleChange}
                                                            className="form-control"
                                                            placeholder="dc1"
                                                            disabled
                                                        />
                                                        {errors.dc1 && (
                                                            <div className="error">{errors.dc1}</div>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
