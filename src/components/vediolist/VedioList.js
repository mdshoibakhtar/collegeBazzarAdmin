...
import { DeleteRole, DeleteTestimonial, deleteVideoGallery, getListRole, getTestimonial, getVideoGallery } from "../../api/login/Login"
...
function VedioList() {
    ...
    const getListUserType = async (num) => {
        setLoading(true)
        try {
            const data = await getVideoGallery(num,count)
            setData(data)
