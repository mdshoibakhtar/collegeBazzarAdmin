...
const GSTExpenseEntry = () => {
    const breadCrumbsTitle = {
        ...
        title_1: "Transaction",
        title_2: 'GST',
        title_3: `List Of GST Expense Entry`,
        path_2: ``
    };
    return (
        <>
                        ...
                        <div className="table-responsive active-projects style-1">
                            <div className="tbl-caption">
                                <h4 className="heading mb-0">
                                    List Of GST Expense Entry
                                </h4>
                                <div>
                                    <Link className="btn btn-primary btn-sm" to="/gstexpenseentry/add" role="button" aria-controls="offcanvasExample">+ Add New</Link>
                                </div>
                            </div>
