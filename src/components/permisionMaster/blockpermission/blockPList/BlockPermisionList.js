...
function BlockPermisionList({ data, page, count, cancel, confirm, loading,onChangeVal,totalCount }) {
    return (
        <>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption">
                                    <h4 className="heading mb-0"> Block List </h4>
                                    <div>
                                            ...
                                            return <tr role="row" className="odd">
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        <Link to={`/admin/block-master/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1"><i className="fa fa-pencil" /></Link>
                                                        <Popconfirm
                                                            title="Delete Block Address!"
...
export default BlockPermisionList
