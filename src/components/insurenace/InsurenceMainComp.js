...
import InsurenceListReport from './InsurenceListReport'
import { useParams } from 'react-router-dom'

function InsurenceMainComp({title_1,title_2,title}) {
  ...
  return (
    <>
      ...
      <InsurenceListReport title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData}/>
    </>
  )
}

export default InsurenceMainComp
