...
function MaterialinbutpurchList() {
    return (
        <section>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption">
                                    <h4 className="heading mb-0">Material in but purchase not made
                                    </h4>
                                    <div>
                                ...
                                <div class="card mt-2"><div>LocationId : KOLHAPUR MAIN</div><div>Type : Detail</div></div>
...
export default MaterialinbutpurchList
