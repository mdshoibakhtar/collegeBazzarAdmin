...
function MaterialinbutpurchFillter() {
                                        ...
                                        <div className="card-body p-0">
                                            <div className="table-responsive active-projects style-1">
                                                <div className="tbl-caption tbl-caption-2">
                                                    <h4 className="heading mb-0">Material in but purchase not made</h4>
                                                </div>
                                                <form className="tbl-captionn" onSubmit={submitForm}>
                                                    <div className="row">
                                                        <div className="col-xl-4 mb-3">
                                                            <small>LocationId</small>
                                                            <select
...
export default MaterialinbutpurchFillter
