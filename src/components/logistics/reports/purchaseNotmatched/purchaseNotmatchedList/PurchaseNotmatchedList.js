...
function PurchaseNotmatchedList() {
    const data = {
        "invoices": [
            {
                "invNo": "HO212212P0106",
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption">
                                    <h4 className="heading mb-0">Purchase Not matched with Inward
                                    </h4>
                                    <div>
...
export default PurchaseNotmatchedList
