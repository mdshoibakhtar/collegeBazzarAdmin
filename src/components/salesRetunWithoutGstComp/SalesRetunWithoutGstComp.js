...
function SalesRetunWithoutGstComp() {
    return (
        <>
            <ToastContainer />
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0"><b>Sales Return (Without GST)</b></h4>
                                        <div>
                                            <ExportPdf />
                                            <Link className="btn btn-primary btn-sm" to="/ele-sales-return/without-gst/create" role="button" aria-controls="offcanvasExample">+ CREATE SR (Without GST)</Link>
                                        </div>
                                    </div>
...
export default SalesRetunWithoutGstComp