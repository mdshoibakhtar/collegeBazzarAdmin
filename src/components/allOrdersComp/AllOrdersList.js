                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0"><b>All Orders</b></h4>
                                        <div>
                                            <ExportPdf />
                                        </div>
                                    </div>
                                        ...
                                        <table id="empoloyees-tblwrapper" className="table dataTable no-footer exppdf" role="grid" aria-describedby="empoloyees-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ textAlign: 'center' }}>Buyer Mobile</th>
                                                    ...
                                                    <th style={{ textAlign: 'center' }}>Order Delivery Status</th>
                                            ...
                                            <tbody>
                                                <tr role="row" className="odd">
                                                    ...
                                                    <td className="sorting_1" style={{ textAlign: 'center' }}>
                                                        <span style={{ padding: '5px 10px', borderRadius: '5px', backgroundColor: 'green', color: 'black' }}>Paid</span>
                                                    </td>
                                                    <td className="sorting_1" style={{ textAlign: 'center' }}>Abc </td>
                                                    <td className="sorting_1" style={{ textAlign: 'center' }}>Abc </td>
