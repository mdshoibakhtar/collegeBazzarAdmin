...
import VocharListReport from './VocharListReport'
import { useParams } from 'react-router-dom'

function VocherMainComp({title_1,title_2,title}) {
  ...
  return (
    <>
      ...
      <VocharListReport title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData}/>
    </>
  )
}

export default VocherMainComp
