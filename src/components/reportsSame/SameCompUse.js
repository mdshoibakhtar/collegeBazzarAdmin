...
import SameListCOmp from './SameListCOmp'
import { useParams } from 'react-router-dom'
import Loadar from '../../common/loader/Loader'

function WaterMainComp({ title_1, title_2, title }) {
  ...
  return (
    <>
      ...
      <SameListCOmp title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData} />
    </>
  )
}

export default WaterMainComp
