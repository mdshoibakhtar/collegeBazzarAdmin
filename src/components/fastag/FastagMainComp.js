...
import FastagListReports from './FastagListReport'
import { useParams } from 'react-router-dom'

function FastagMainComp({title_1,title_2,title}) {
  ...
  return (
    <>
      ...
      <FastagListReports title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData}/>
    </>
  )
}

export default FastagMainComp
