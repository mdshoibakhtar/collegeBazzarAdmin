...
import ReceiptRegister from "../../AccountBook/receiptRegister/ReceiptRegister";

function JobworkOutOrder() {
  return (
    <>
            ...
            <div className="card-body p-0">
              <div className="table-responsive active-projects style-1">
                <div className="tbl-caption">
                  <h4 className="heading mb-0">Jobwork Out Order</h4>
                ...
                <div className="dataTables_wrapper no-footer">
                  ...
                  <div
                    ...
                    aria-live="polite"
                  >
                    Total {ReceiptRegister.length} entries
                  </div>
