...
function AddInterBankStockTransferComp() {
    return (
        <>
            <ToastContainer />
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption tbl-caption-2">
                                        <h4 className="heading mb-0"><b>Add New Inter Branch Stock Transfer Note</b><small style={{ textTransform: 'capitalize', marginLeft: '5px' }}> Control panel</small></h4>
                                    </div>
                                    <form className="row cusforms mt-3" style={{ padding: "0 20px" }}>
                                        ...
                                        <div className="form-group col-4 mt-2">
                                            <label htmlFor="fromDate">Sold to Branch</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                placeholder='Enter Sold to Branch'
                                                id="fromDate"
                                            />
                                        </div>
                                        <div className="form-group col-4 mt-2">
                                            <label htmlFor="fromDate">Purchase Order No</label>
                                            <select className="form-select form-control" aria-label="Default select example">
                                                <option selected>Select DPurchase Order No</option>
...
export default AddInterBankStockTransferComp