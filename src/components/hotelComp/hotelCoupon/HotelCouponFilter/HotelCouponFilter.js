...
import AddHotelCoupon from '../addHotelCoupon/AddHoteCoupon';
function HotelCouponFilter({ count, page, submitForm, title }) {
    ...
    return (
        <>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b> SEARCH HOTEL COUPON
                                    </b></h4>
                                </div>
                                <Formik
                            ...
                            <i class="fas fa-plus"></i> Add Hotel Coupon    
                                </button>
            ...
            <AddHotelCoupon show={show} setShow={setShow} />
        </>
    )
}

export default HotelCouponFilter