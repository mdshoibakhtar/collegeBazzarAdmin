...
function HotelCancillationFilter({ count, page, submitForm, title }) {
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b> SEARCH Hotel cancellations
                                    </b></h4>
                                </div>
                                <Formik
...
export default HotelCancillationFilter