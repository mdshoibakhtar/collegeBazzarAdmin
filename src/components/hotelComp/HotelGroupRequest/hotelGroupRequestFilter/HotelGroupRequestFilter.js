...
function HotelGroupRequestFilter({ count, page, submitForm, title }) {
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b> Search Hotel Group Request  </b></h4>
                                </div>
                                <Formik
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-xl-3 mb-3">
                                                        <select className="form-select" aria-label="Default select example" name="ServiceProvider"
                                                            ...
                                                            <option value={3}>Hotel Location</option>
...
export default HotelGroupRequestFilter