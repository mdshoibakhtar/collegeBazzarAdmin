...
function AddHotelMarkup({ show, setShow, handleSubmit }) {
    const countries = [
        ...
        <>
            <Modal show={show} onHide={() => setShow(!show)} size="lg"
                ...
                <Modal.Header closeButton className=' bg-secondary'>
                    <Modal.Title className='text-light text-uppercase'>Add Hotel Mark UP
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                                    ...
                                    <form className="tbl-captionn" onSubmit={handleSubmit}>
                                        <div className="row">
                                            ...
                                            <select className="form-select" aria-label="Default select example" name="ServiceProvider"
                                                    ...
                                                    onChange={handleChange}
                                                >
                                                    <option >Hotel Markup Type </option>
                                                    <option value={1}>Per Night</option>
                                                    <option value={3}>Per Room</option>
                                                </select>
                                            </div>
