...
function ListAttribute({ data, cancel, confirm }) {
    return (
        <>
            <ToastContainer />
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0"><b>All Attributes</b></h4>
                                        <div>
                                            <ExportPdf />
                                        </div>
                                    </div>
                                                ...
                                                {data?.map((item, i) => {
                                                    return <tr role="row" className="odd">
                                                        ...
                                                        <td style={{ position: 'relative' }} className="d-flex align-item-center" >
                                                            <Link to={`/product_attribute/${item.uid}`} className="btn btn-primary shadow btn-xs sharp me-1"><i className="fa fa-pencil" /></Link>
                                                            <Popconfirm
                                                                title="Delete !"
