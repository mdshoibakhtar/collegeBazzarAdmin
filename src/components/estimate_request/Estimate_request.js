...
import { Estimate_request_Filter } from "./Estimate_request_Filter";


const Estimate_request = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Estimate Reques",
        title_2: 'Estimate Request',
        path_2: ""
    };
    return (
        <>
                    ...
                    <div className="card-body p-0">
                        <div className="table-responsive active-projects style-1">
                            <div className="tbl-caption">
                                ...
                                <div>
                                    <Link className="btn btn-primary btn-sm" to="/add_estimate_request" role="button" aria-controls="offcanvasExample">+ Add New</Link>
                                </div>
                            </div>
...
export default Estimate_request