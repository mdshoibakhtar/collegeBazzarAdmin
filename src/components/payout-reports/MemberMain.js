...
import MemberCompFilter from './MemberCompFilter'
import MemberReportList from './MemberReportList'

function MemberMain({ title_1, title_2, title }) {
  ...
  return (
    ...
    {loading && <Loadar />}
      ...
      <MemberCompFilter title={title} initialValues={initialValues} userData={userData} submitForm={submitForm} aepsData={aepsData} />
      <MemberReportList title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData} />
    </>
  )
}
