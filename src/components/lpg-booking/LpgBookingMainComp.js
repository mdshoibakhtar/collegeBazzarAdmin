...
import LpgBookingListReport from './LpgBookingListReport'
import { useParams } from 'react-router-dom'

function LpgBookingMainComp({ title_1, title_2, title }) {
  ...
  return (
    <>
      ...
      <LpgBookingListReport title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData} />
    </>
  )
}

export default LpgBookingMainComp
