...
import SuplierPaidReportFilter from "./suplierPaidReportFilter/SuplierPaidReportFilter";


const SuplierPaidReport = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Travel CRM Reports",
        title_2: 'Supplier Payment Paid Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Supplier Payment Paid Report</h4>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px' }}>Made Of Payment</th>
...
export default SuplierPaidReport