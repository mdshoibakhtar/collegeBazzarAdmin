...
const ContactReportUserWiseFilter = () => {
    return (
                ...
                <div className="card-body p-0">
                    <div className="table-responsive active-projects style-1">
                        <div className="tbl-caption tbl-caption-2">
                            <h4 className="heading mb-0 p-2">Filter Contacts report User wise</h4>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-4 mb-3">
                                    ...
                                    <select className="form-control" aria-label="Default select example">
                                        <option selected>Open this select Sales Person</option>
...
export default ContactReportUserWiseFilter