...
import ContactReportUserWiseFilter from "./contactReportUserWiseFilter/ContactReportUserWiseFilter";

const ContactReportUserWise = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Travel CRM Reports",
        title_2: 'Contacts report User wise',
        path_2: ``
    };
    return (
        <>
            <Breadcrumbs breadCrumbsTitle={breadCrumbsTitle} />
            <ContactReportUserWiseFilter />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Contacts report User wise</h4>
                                    </div>
...
export default ContactReportUserWise