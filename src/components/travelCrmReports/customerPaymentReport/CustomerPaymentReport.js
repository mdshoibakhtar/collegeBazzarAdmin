...
import CustomerPaymentReportFilter from "./customerPaymentReportFilter/CustomerPaymentReportFilter";
...
const CustomerPaymentReport = () => {
    const breadCrumbsTitle = {
        ...
        title_2: 'Customer Payment Received Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Customer Payment Received Report</h4>
