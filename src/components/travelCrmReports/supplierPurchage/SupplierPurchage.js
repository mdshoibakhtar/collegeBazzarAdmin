...
import SupplierPurchageFilter from "./supplierPurchageFilter/SupplierPurchageFilter";


const SupplierPurchage = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Travel CRM Reports",
        title_2: 'Purchase Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Purchase Report</h4>
...
export default SupplierPurchage