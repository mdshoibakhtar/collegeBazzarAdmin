...
import CompanyInvoicelistFilter from "./companyInvoicelistFilter/CompanyInvoicelistFilter";
...
const CompanyInvoicelist = () => {
    const breadCrumbsTitle = {
        ...
        title_2: 'Company Invoice list',
        path_2: ``
    };
    return (
        <>
            <Breadcrumbs breadCrumbsTitle={breadCrumbsTitle} />
            <CompanyInvoicelistFilter />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Company Invoice list</h4>
                                    </div>
