...
import CustomerSaleReportFilter from "../../../pages/travelCrmReports/customerSaleReport/customerSaleReportFilter/CustomerSaleReportFilter";
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Sale Report</h4>
