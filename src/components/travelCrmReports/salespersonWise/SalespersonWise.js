...
import SalespersonWiseFilter from "./salespersonWiseFilter/SalespersonWiseFilter";



const SalespersonWise = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Travel CRM Reports",
        title_2: 'Salesperson Wise Report',
        path_2: ``
    };
    return (
        <>
            <Breadcrumbs breadCrumbsTitle={breadCrumbsTitle} />
            <SalespersonWiseFilter />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Salesperson Wise Report</h4>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '100px' }}>Destination City</th>
                                                    <th style={{ width: '100px' }}>Destination Country</th>
                                                    <th style={{ width: '100px' }}>Tour Start Date</th>
...
export default SalespersonWise