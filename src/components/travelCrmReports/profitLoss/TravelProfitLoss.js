...
import ProfitLossFilter from "./profitLossFilter/ProfitLossFilter";





const TravelProfitLoss = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Travel CRM Reports",
        title_2: 'Profit - Loss Report',
        path_2: ``
    };
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Profit - Loss Report</h4>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer exppdf" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px' }}>Customer Paid</th>
                                                    <th style={{ width: '150px' }}>Customer Pending</th>
                                                    <th style={{ width: '150px' }}>Customer Total</th>
                                                    <th style={{ width: '150px' }}>Customer Tax Amount</th>
                                                    <th style={{ width: '150px' }}>Supplier Paid</th>
                                                    <th style={{ width: '150px' }}>Supplier Pneding</th>
                                                    <th style={{ width: '150px' }}>Supplier Total</th>
                                                    <th style={{ width: '150px' }}>Supplier Tax Amount</th>
                                                    <th style={{ width: '150px' }}>Profit/Loss Total</th>
...
export default TravelProfitLoss