...
import ManagmentFilter from './DistributorDepositFilter'
import ManagmentList from './DistributorDepositList'
import DistributorDepositFilter from './DistributorDepositFilter'
import DistributorDepositList from './DistributorDepositList'

function DistributorRequest() {
    const breadCrumbsTitle = {
        title_1: "",
        title_2: "Distributor Deposit Request"
    }
