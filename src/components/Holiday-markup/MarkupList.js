...
function MarkupList({ onChangeVal }) {
  ...
  const vendorData = [
    { id: 1, agentClass: 'Class A', value: 10, maxLimit: 1000, themeName: 'Summer Special', destinationName: 'Paris', markupType: 'Percentage', status: 'Active', created: '2024-09-01', modified: '2024-09-02' },
    { id: 2, agentClass: 'Class B', value: 20, maxLimit: 2000, themeName: 'Winter Getaway', destinationName: 'New York', markupType: 'Flat', status: 'Inactive', created: '2024-09-02', modified: '2024-09-03' },
  ];
    ...
    <section className="vendor-balance card">
      <div className='card'>
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <h3>Holiday Markup</h3>
          <div className='d-flex'>
            <button type="button" className=" m-1 btn btn-primary" onClick={() => setModalShow(true)}>  Add Holiday Markup</button>
