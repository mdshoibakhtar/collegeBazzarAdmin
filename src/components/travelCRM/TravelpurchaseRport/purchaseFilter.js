...
export function SalePurchaseFilter() {
    return (
                ...
                <div className="table-responsive active-projects style-1">
                        ...
                        <div className="col-3">
                                    ...
                                    <div className="col-7">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex gap-1">
                                                ...
                                                <div className="d-flex align-items-center">
                                                    <input className="" type="radio" name="wise"/>
                                                    <label className="d-block my-0 fs-6 fw-normal mx-1">Invoice wise</label>
                                                </div>
                                                <div className="d-flex align-items-center">
                                                    <input className="" type="radio" name="wise"/>
                                                    <label className="d-block my-0 fs-6 fw-normal mx-1">Supplier wise</label>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                    ...
                                    <div className="mt-2">
                                            ...
                                            <input className="form-control" type="number" placeholder="Supplier"/>
                                        </div>
                                    </div>
                                    <div className="col-3">
                                        <div className="mt-2">
