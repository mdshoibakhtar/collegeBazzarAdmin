...
import DthReport from './DthReport'
import { useParams } from 'react-router-dom'
function Dth({ title_1, title_2, title }) {
  ...
  return (
    <>
      ...
      <DthReport title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData} />
    </>
  )
}
