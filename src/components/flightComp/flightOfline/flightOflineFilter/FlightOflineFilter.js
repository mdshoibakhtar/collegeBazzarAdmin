...
import FlightFormOfline from '../flightFormOfline/FlightFormOfline';
function FlightOflineFilter({ count, page, submitForm, title }) {
    ...
    return (
        <>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b> Flight Offline Search
                                    </b></h4>
                                </div>
                                <Formik
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-xl-3 mb-3">
                                                        <select className="form-select" aria-label="Default select example" name="ServiceProvider"
                                                            ...
                                                            <option value={1}>Markup For</option>
                                                            <option value={2}>Markup Type</option>
                            ...
                            <div className='d-flex justify-content-end'>
                                ...
                                <i class="fas fa-plus"></i> Add Flight Ofline
                                </button>
            ...
            <FlightFormOfline show={show} setShow={setShow} />
        </>
    )
}

export default FlightOflineFilter