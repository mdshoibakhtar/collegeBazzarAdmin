...
import { deleteTRCRM_other, gitTRCRM_other } from "../../../api/login/Login";
import OtherMasterFilter from "./otherMasterFilter/OtherMasterFilter";
...
const OtherMaster = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await gitTRCRM_other(clone)
    ...
    const deleteData = async (id) => {
        try {
            const res = await deleteTRCRM_other(id)
            // console.log(res);
            if (res?.error == false) {
                toastSuccessMessage()
    ...
    return (
        <>
            ...
            <OtherMasterFilter filterInitial={filterInitial} handleChange={handleChange} getTransitionReport={getTransitionReport} />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Travel Other Master
                                        </h4>
                                        <Link to='/travel-other-master-add' className="btn btn-primary">Add Travel Other Master</Link>
                                    </div>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px' }}>Number Of Days</th>
