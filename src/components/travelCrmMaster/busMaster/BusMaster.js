...
import { deleteTRCRM_bus, getTRCRM_bus } from "../../../api/login/Login";
...
const BusMaster = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await getTRCRM_bus(clone)
    ...
    const deleteData = async (id) => {
        try {
            const res = await deleteTRCRM_bus(id)
            // console.log(res);
            if (res?.error == false) {
                toastSuccessMessage()
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Travel Bus Master</h4>
                                        <Link to='/travel-bus-master-add' className="btn btn-primary">Add Travel Bus Master</Link>
                                    </div>
                                        ...
                                        <table id="banner-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="banner-tblwrapper_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style={{ width: '150px' }}>Preference</th>
