...
import { deleteTRCRM_cruise, getTRCRM_cruise } from "../../../api/login/Login";
import CruiseFilter from "./cruiseFilter/CruiseFilter";
...
const TravelCruise = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await getTRCRM_cruise(clone)
    ...
    const deleteData = async (id) => {
        try {
            const res = await deleteTRCRM_cruise(id)
            // console.log(res);
            if (res?.error == false) {
                toastSuccessMessage()
    ...
    return (
        <>
            ...
            <CruiseFilter filterInitial={filterInitial} handleChange={handleChange} getTransitionReport={getTransitionReport} />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Travel Cruise Master
                                        </h4>
                                        <Link to='/travel-cruise-add' className="btn btn-primary">Add Travel Cruise Master</Link>
                                    </div>
