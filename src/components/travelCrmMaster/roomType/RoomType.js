...
import { deleteTRCRM_room_type_master, gitTRCRM_room_type_master } from "../../../api/login/Login";
...
const RoomType = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await gitTRCRM_room_type_master(clone)
    ...
    const deleteData = async (id) => {
        try {
            const res = await deleteTRCRM_room_type_master(id)
            // console.log(res);
            if (res?.error == false) {
                toastSuccessMessage()
    ...
    return (
        <>
            ...
            <RoomTypeFilter filterInitial={filterInitial} handleChange={handleChange} getTransitionReport={getTransitionReport} />
            <div>
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption">
                                        <h4 className="heading mb-0 p-2">Room Type Master
                                        </h4>
                                        <Link to='/room-type-master-add' className="btn btn-primary">Add Room Type Master</Link>
                                    </div>
                                                    ...
                                                    return <tr role="row" key={item?._id}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex">
                                                                <Link to={`/room-type-master-update/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1">
