...
function CreditReport({ onChangeVal, aepsData, title }) {
    return (
        <>
            <ToastContainer />
                                        ...
                                        <table id="table-to-xls" className="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tblwrapper_info">
                                            <thead>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th className="sorting_asc text-center" tabIndex={0} aria-controls="empoloyees-tblwrapper" rowSpan={1} colSpan={1} aria-sort="ascending" aria-label="Employee ID: activate to sort column descending" style={{ width: '122.312px' }}>
                                                        Ref ID
                                                    </th>
