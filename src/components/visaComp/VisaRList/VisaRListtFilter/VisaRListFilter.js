...
function VisaRListFilter({ count, page, submitForm, title }) {
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b> SEARCH VISA LIST
                                    </b></h4>
                                </div>
                                <Formik
                            ...
                            <div className='d-flex justify-content-end'>
                                <Link className="btn btn-secondary pd-x-20" to = "add-visa">
...
export default VisaRListFilter