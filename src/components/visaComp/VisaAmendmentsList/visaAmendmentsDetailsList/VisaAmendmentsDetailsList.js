...
function VisaAmendmentsDetailsList({ selectAll, handleSelectAll, handleCheckboxChange, apesData, selectedUsers }) {
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption">
                                    <h4 className="heading mb-0"><b>Visa Amendments List
                                    </b></h4>
                                    <div>
                                        {/* <ExportPdf /> */}
...
export default VisaAmendmentsDetailsList