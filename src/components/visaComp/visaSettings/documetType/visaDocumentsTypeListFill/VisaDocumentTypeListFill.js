...
import VisaAddDocumentType from '../visaAddDocumentType/VisaAddDocumentType';
function VisaDocumentTypeListFilter({ count, page, submitForm, title }) {
    ...
    return (
        <>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b> SEARCH DOCUMENTS TYPE LIST
                                    </b></h4>
                                </div>
                                <Formik
                            ...
                            <div className='d-flex justify-content-end'>
                                ...
                                <i class="fas fa-plus"></i> Add Visa Document
                                </button>
            ...
            <VisaAddDocumentType show={show} setShow={setShow} />
        </>
    )
}

export default VisaDocumentTypeListFilter