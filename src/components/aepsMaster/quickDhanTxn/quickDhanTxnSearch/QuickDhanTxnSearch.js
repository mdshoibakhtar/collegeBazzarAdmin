...
function QuickDhanTxnSearch({ initialValues, validate, submitForm }) {
    return (
        <>
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0"><b>Quick Dhan Txn Search  </b></h4>
                                </div>
                                <Formik
                                        ...
                                        return (
                                            <form className="tbl-captionn" onSubmit={handleSubmit}>
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-6 col-md-12 mg-t-10 mg-sm-t-25">
...
export default QuickDhanTxnSearch
