...
import ManagmentFilter from './ManagmentFilter'
...
function AccountManagement() {
    ...
    return (
        <>
            ...
            <ManagmentFilter initialValues={initialValues} page={page} count={count} userData={userData} submitForm={submitForm} aepsData={aepsData} />
            <ManagmentList />
        </>
    )
}
