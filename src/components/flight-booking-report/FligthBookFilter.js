...
function FligthBookFilter({ aepsData, submitForm, title }) {
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-xl-3 mb-3">
                                                        <CustomInputField
                                                            ...
                                                            hasError={errors.Arrival && touched.Arrival}
                                                            onChange={handleChange}
                                                            onBlur={handleBlur}
                                                            errorMsg={errors.Arrival}
                                                            id="Arrival"
                                                        />
                                                    </div>
                                                    <div className="col-xl-3 mb-3">
                                                        <CustomInputField
                                                            ...
                                                            hasError={errors.Departure && touched.Departure}
                                                            onChange={handleChange}
                                                            onBlur={handleBlur}
                                                            errorMsg={errors.Departure}
                                                            id="Departure"
                                                        />
                                                    </div>
...
export default FligthBookFilter;
