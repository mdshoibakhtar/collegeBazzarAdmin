...
function AddSalesReturnWithoutGstComp() {
    return (
        <>
            <ToastContainer />
                            ...
                            <div className="card-body p-0">
                                <div className="table-responsive active-projects style-1">
                                    <div className="tbl-caption tbl-caption-2">
                                        <h4 className="heading mb-0"><b>Add New Sales Return (Without GST)</b><small style={{ textTransform: 'capitalize', marginLeft: '5px' }}> Control panel</small></h4>
                                    </div>
                                    <form className="row cusforms mt-3" style={{ padding: "0 20px" }}>
                                        ...
                                        <div className="form-group col-4 mt-2">
                                            <label htmlFor="fromDate">Sales Invoice Date</label>
                                            <input
                                                type="date"
                                                className="form-control"
                                        ...
                                        <div className="form-group col-4 mt-2">
                                            <label htmlFor="fromDate">Outstanding</label>
                                            <input
                                                disabled
                                                type="date"
                                                className="form-control"
                                        ...
                                        <div className="row mb-4">
                                            <h3 className='mt-5 mb-4'>Rent Product</h3>
                                            <div className="table-responsive active-projects style-1">
...
export default AddSalesReturnWithoutGstComp