...
import MuncilpeListReport from './MuncilpeListReport'
import { useParams } from 'react-router-dom'

function MuncipleMainComp({title_1,title_2,title}) {
  ...
  return (
    <>
      ...
      <MuncilpeListReport title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData}/>
    </>
  )
}

export default MuncipleMainComp
