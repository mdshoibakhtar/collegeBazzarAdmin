...
import {blockDelte, getCreblock,} from '../../api/login/Login'
...
function BlockList() {
    ...
    const getPaginationApi = async (page) => {
        // setLoading(true)
        try {
            const res = await getCreblock(1 , 100)
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption">
                                    <h4 className="heading mb-0">Block</h4>
                                    <div>
                                        <Link className="btn btn-primary btn-sm" to="/newblock" role="button" aria-controls="offcanvasExample">+ New Block</Link>
